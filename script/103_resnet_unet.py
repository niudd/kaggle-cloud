...
MODEL = 'resnet34'#'RESNET34', 'RESNET18', 'INCEPTION_V3', 'BNINCEPTION', 'SEResnet50'
...
checkpoint_path = '../checkpoint/unet_%s_%dx%d_v1_seed%s'%(MODEL, IMG_SIZE[0], IMG_SIZE[1], SEED)
LOG_PATH = '../logging/unet_%s_%dx%d_v1_seed%s.log'%(MODEL, IMG_SIZE[0], IMG_SIZE[1], SEED)#
#torch.cuda.manual_seed_all(SEED)
