...
checkpoint_path = '../checkpoint/deeplabv3plus_%s_%dx%d_v10_seed%s'%(MODEL, IMG_SIZE[0], IMG_SIZE[1], SEED)
LOG_PATH = '../logging/deeplabv3plus_%s_%dx%d_v10_seed%s.log'%(MODEL, IMG_SIZE[0], IMG_SIZE[1], SEED)
#torch.cuda.manual_seed_all(SEED)
